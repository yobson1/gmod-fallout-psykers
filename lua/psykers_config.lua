...
Psykers.Config.RegularEffectChance = 98
...
-- Cooldowns
Psykers.Config.Cooldowns.Mind = 15
Psykers.Config.Cooldowns.Body = 300
Psykers.Config.Cooldowns.Soul = 600
Psykers.Config.Cooldowns.SoulDuration = 180
